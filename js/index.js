...
(function() {
  ...
  setSpeed = function() {
    if (powerLevel === 0) {
      ...
      return speed = activePath.len / ((100 * 10000) / powerLevel);
    }
  };
  ...
  guiLayer.add(dial = new Kinetic.Image({
    ...
    dragBoundFunc: function(pos, evt) {
      ...
      */
      ...
      var rotateTo, rotation, step, _k, _len1;
